...
Static review site for NFT marketplaces, built with Astro and ready for GitHub Pages.

**Default URL**: `https://victomteng1997.github.io/NFTMarketplaceReview/`

## Local development

```bash
npm install
npm run dev       # http://localhost:4321/NFTMarketplaceReview/
...
This repo is prepared for SEO coverage around NFT marketplaces. Starter articles live under `src/content/reviews/` and use review/comparison schema, RSS, JSON feed, sitemap, and base-path-safe internal links.
...
Push this project to a GitHub repository named `NFTMarketplaceReview` and enable GitHub Pages from Actions. The workflow at `.github/workflows/deploy.yml` builds and publishes `dist/` automatically.

Default deploy target:

```js
const SITE_URL = 'https://victomteng1997.github.io';
const BASE_PATH = '/NFTMarketplaceReview';
```
